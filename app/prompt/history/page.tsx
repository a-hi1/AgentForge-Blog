                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-[rgba(255,255,255,0.06)]">
                    ...
                    <Link
                      ...
                      className="mt-2 w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-[#070707] border border-[rgba(255,255,255,0.1)] text-[#71717A] hover:text-[#FAFAFA] text-sm transition-all"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
